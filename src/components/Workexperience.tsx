      ...
      <div className="w-full flex flex-col gap-8 px-10">
        ...
        <div className=" px-2">
          <Experience
            ...
            imageSrc={codecoterie}
            company="CodeCoterie"
            position="Frontend Developer"
            description={[
              "Developed front-end user interface using React, Tailwind, Next and JavaScript for Web Apps",
          ...
          <Experience
            ...
            description={[
              "Software expert and support for the integrated accounting software Nosa at Iran Software and Hardware Company.",
              "Specialist in the payroll module of the Nosa software and Development of Payroll and Compensation Calculations.",
            ]}
          />
        </div>
      </div>
